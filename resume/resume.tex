...
\begin{enumerate}
	\educationitemfull{Stony Brook University}{Sept 2016 - Dec 2017}{MS , Computer Science}{Stony Brook,USA}
...
\begin{enumerate}
\workitemfull{Palo Alto Networks}{May 2021 - Present}{Principle Software Engineer}{San Francisco, USA}
	\begin{enumerate}
		\item[-] Designing and building data processing pipelines using Apache Beam and Google's Dataflow.	
	\end{enumerate}
