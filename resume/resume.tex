...
\begin{enumerate}
	\educationitemfull{Stony Brook University}{Sept 2016-Present}{MS , Computer Science}{Stony Brook,USA}{GPA = 3.8/4}
...
\begin{enumerate}
	...
	\begin{enumerate}
		\item[-] Taking out independent modules from a big monolithic application into their own micro services. 
		\item[-] Adding end to end features to the main application. 
		\item[-] \textbf{Tech Stack} - Java, Javascript, Spring boot, Mysql, Kafka, Angular1, Docker, Kubernetes
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\item[-] Built a micro service for transforming graphics animation data generated from user?s actions to
	...
	%playdom
	\workitemfull{Disney (Playdom) }{Jun 2011-Mar 2014}{Software Engineer}			{Bangalore,India}
	\begin{enumerate}
